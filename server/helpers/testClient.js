...
var configFilePath = "/Users/olivieri/git/api-bootstrap/fabric-network/network-config-org1.json";
//const CONFIG = fs.readFileSync(configFilePath, 'utf8')

var fClient = FabricClient.loadFromConfig(configFilePath);
console.log(fClient);
//console.log(client.enrollmentID);

var store_path = "/Users/olivieri/git/api-bootstrap/WALLETS/wallet/admin";

var member_user = null;
var tx_id = null;
var channel = fClient.getChannel('defaultchannel');
...
FabricClient.newDefaultKeyValueStore({
    ...
    fClient.setStateStore(state_store);
    ...
    fClient.setCryptoSuite(crypto_suite);

    // get the enrolled user from persistence, this user will sign all requests
    return fClient.getUserContext('admin', true);
    //fClient.getUserContext('admin', true);
    ...
    tx_id = fClient.newTransactionID();
